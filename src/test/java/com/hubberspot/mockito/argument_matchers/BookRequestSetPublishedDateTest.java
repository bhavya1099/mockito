...
public class BookRequestSetPublishedDateTest {
	...
	public void testSetValidPublishedDate() {
		...
		BookRequest bookRequest = new BookRequest("Title", 1000, null);
		// Act
		bookRequest.setPublishedDate(date);
		// Assert
		assertEquals(date, bookRequest.getPublishedDate(), "The published date wasn't set correctly");
	}
	...
	public void testSetNullDate() {
		...
		// Assert
		assertNull(bookRequest.getPublishedDate(), "The published date wasn't set to null correctly");
	}
