...
public class BookSetTitleTest {
	...
	public void setup() {
		...
		// TODO: change values as per need
		book = new Book("ID123", "DummyTitle", 100, LocalDate.now());
	}

	// Scenario: Positive Scenario - Set a regular title
	@Test
	...
	// Scenario: Negative Scenario - Set title with null
	@Test
	...
	// Scenario: Edge Case - Set the title with an empty string
	@Test
