...
public class BookGetBookIdTest {
	...
	public void testBookIdRetrieval() {
		// Arrange
		String expectedBookId = "B1001";
		Book book = new Book(expectedBookId, "Test Title", 10, LocalDate.now());
		// Act
	...
	public void testBookIdForNull() {
		// Arrange
		Book book = new Book(null, "Test Title", 10, LocalDate.now());
		// Act
		String actualBookId = book.getBookId();
		// Assert
	...
	public void testBookIdForEmptyString() {
		// Arrange
		Book book = new Book("", "Test Title", 10, LocalDate.now());
		// Act
		String actualBookId = book.getBookId();
		// Assert
